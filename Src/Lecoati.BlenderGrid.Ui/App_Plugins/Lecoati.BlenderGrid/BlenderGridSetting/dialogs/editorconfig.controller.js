angular.module("umbraco").controller("BlenderGrid.EditorConfig.Controller",
    function ($scope, assetsService, $http, BlenderGridRequestHelper, dialogService) {
        ...
        $scope.isBlenderEditor = function () {
            if ("/App_Plugins/Lecoati.BlenderGrid/BlenderGridEditor/BlenderGridEditor.html" === $scope.model.value.view) {
                return true;
            }
            return false;
        }
        ...
        $scope.openParameterConfig = function (parameter) {
            ...
            if (parameter) {
                var dialog = dialogService.open({
                    template: '/App_Plugins/Lecoati.BlenderGrid/BlenderGridSetting/Dialogs/parameterconfig.html',
                    show: true,
                    dialogData: {
                        parameter: parameter
                    },
