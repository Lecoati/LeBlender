angular.module("umbraco").controller("leblenderproperties.controller",
    function ($scope, $rootScope, assetsService, $http, LeBlenderRequestHelper, dialogService) {
        ...
        // render have to be always = /App_Plugins/Lecoati.LeBlender/editors/leblendereditor/views/Base.cshtml
        ...
        $scope.openPropertyConfig = function (parameter) {
            ...
            var dialog = dialogService.open({
                template: '/App_Plugins/Lecoati.LeBlender/editors/leblendereditor/Dialogs/parameterconfig.prevalues.html',
                show: true,
                dialogData: {
                    parameter: parameter,
        ...
        $scope.$on('editorConfigSaving', function () {
            ...
            $scope.model.parentValue.render = "/App_Plugins/Lecoati.LeBlender/editors/leblendereditor/views/Base.cshtml";
        });
