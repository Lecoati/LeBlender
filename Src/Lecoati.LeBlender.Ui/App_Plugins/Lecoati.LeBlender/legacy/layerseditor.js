angular.module("umbraco").controller("LeBlender.Dialog.LayersEditor.controller",
    function ($scope, assetsService, $http, dialogService, mediaHelper, imageHelper, $timeout) {
        ...
        // Load css asset
        assetsService.loadCss("/App_Plugins/Lecoati.LeBlender/core/assets/layerseditor.css");
        assetsService.loadCss("/App_Plugins/Lecoati.LeBlender/lib/jquery-ui-1.10.4.custom/css/ui-lightness/jquery-ui-1.10.4.custom.min.css");
